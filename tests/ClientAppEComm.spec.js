...
test.skip('@Web Client App login', async ({ page }) => {
   ...
   //we are getting list of elements and just assigning as a constant variable here for list 
   ...
   for (let i = 0; i < await rows.count(); ++i) {
      ...
      if (orderId.includes(rowOrderId)) {
         await rows.nth(i).locator("button").first().click();//chaining parent and child element
         break;
      }
   }
